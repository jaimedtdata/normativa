# Generated by Django 3.2 on 2022-01-26 15:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('norma_sub', models.CharField(max_length=200, verbose_name='Sub Normativa')),
                ('norma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='normas.subcategories_normas', verbose_name='Normativa')),
            ],
            options={
                'verbose_name_plural': '5.Normas-Sub Tipo Normativa',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normativa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='normas.register_normativa', verbose_name='Normativa')),
            ],
            options={
