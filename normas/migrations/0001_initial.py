    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('denominacion', models.TextField(verbose_name='Denominacion')),
                ('base_legal', models.CharField(max_length=200, verbose_name='Base Legal')),
                ('fecha_publicacion', models.DateField(verbose_name='Publicacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topico', models.ManyToManyField(blank=True, related_name='preguntas', to='normas.Topico_Normas', verbose_name='Topico de norma')),
            ],
            options={
