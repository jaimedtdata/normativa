    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[(1, 'Normativa Edificatoria'), (2, 'Procedimineto Administrativo')], max_length=150)),
                ('estado', models.CharField(choices=[(1, 'Vigente'), (2, 'No vigente'), (3, 'Derogado Parcialmente')], max_length=150)),
