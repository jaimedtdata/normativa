...
from normas.models import Register_Normativa, Subtipo_Normas, ESTADO_CHOICES, Tipo_Normas
...
class NormativaForm(forms.ModelForm):
    ...
    tipo_norma = forms.ModelChoiceField(label="Tipo de Norma", queryset=Tipo_Normas.objects.order_by('order'))
