...
class Topico_Normas(models.Model):
    ...
    icono = models.FileField(upload_to="iconos_topico_normativa", blank=True, null=True, editable=True, verbose_name="Icono del topico")
    created = models.DateTimeField(auto_now_add=True, blank=True, null=True, verbose_name="Fecha de creación" )
    updated = models.DateTimeField(auto_now=True,  blank=True, null=True, verbose_name="Fecha de actualización")
...
class Register_Normativa(models.Model):
    ...
    fecha_publicacion = models.DateField(blank=False,null=False,verbose_name='Publicacion')
