...
from .views import actualizar_normativa, editar_normativa, eliminar_normativa, index, form_normativa, registrar_normativa, registrar_palabras_clave, eliminar_palabras_clave_normativa
...
urlpatterns = [
    ...
    path('<int:normativa>/actualizar', actualizar_normativa, name="actualizar-normativa" ),
